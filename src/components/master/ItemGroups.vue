<template>
    <q-dialog v-model="dlgItemGroups" persistent transition-show="scale" transition-hide="scale">
...
export default defineComponent({
  name: "manufactur",
  props: { show: Boolean, groupname :String},
  setup(props, context) {
    const $store = useStore();
    const dlgItemGroups = ref(false);
    ...
    async function onRequest(props) {
      ...
      try {
        let prop = {
          ...
          is_active:true,
          url: "master/inventory/inventory-group",
        };
    ...
    onMounted(async () => {
      dlgItemGroups.value = props.show;
      group_name.value=props.groupname;
      loaddata();
    });
