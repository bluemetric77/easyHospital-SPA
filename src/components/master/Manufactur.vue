<template>
    <q-dialog v-model="dlgManufactur" persistent transition-show="scale" transition-hide="scale">
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const columns = ref([
      {
        ...
        align: "left",
        label: "Kode",
        field: "manufactur_code",
        sortable: true,
      },
      {
        name: "manufactur_name",
        align: "left",
        label: "Nama Pabrik/Manufaktur",
        field: "manufactur_name",
        sortable: true,
      },
    ]);
    ...
    async function onRequest(props) {
      ...
      try {
        let prop = {
          ...
          sortBy: sortBy,
          is_active:true,
          url: "master/inventory/manufactur",
        };
    ...
    onMounted(async () => {
      dlgManufactur.value = props.show;
      loaddata();
    });
