<template>
  <q-page class="page-app">
    <q-card
      ...
      class="icard"
    >
      <q-bar class="entry-caption"> Setup hak akses </q-bar>
        ...
        >
          ...
          >
              ...
              >
                ...
                >
                  <div v-if="itmdtl.is_header === 0">
                    <q-item
                      :active="link === itmdtl.id"
                      active-class="my-menu-link"
                      @click="link = itmdtl.id"
                    >
                      ...
                      <q-item-section>
                        <q-item-label class="q-mb-sm">
                          ...
                          <div
                            v-if="!(typeof selection[index] === 'undefined')"
                            class="row items-start q-col-gutter-sm"
                          >
                            <div
                              v-for="(action, idx) in security(itmdtl.security)"
                              :key="idx"
                              class="col-xs-4 col-sm-3 col-md-3"
                            >
                              <q-checkbox
                                v-model="selection[index].main[idxdtl].security"
                                :val="action.action"
                        ...
                        >
                          ...
                          <q-item-section>
                            <q-item-label class="q-mb-sm">
                              ...
                              >
                                <div
                                  v-for="(action, idxsecurity) in security(
                                    itmsub.security
                                  )"
                                  :key="idxsecurity"
                                  class="col-xs-4 col-sm-3 col-md-3"
            ...
            <div v-else>
              ...
              >
                <q-tab-panel
                  v-for="(groupreport, idxreport) in groups"
                  :key="idxreport"
                  :name="groupreport.title"
                >
                  <div
                    class="row items-start q-mt-sm q-col-gutter-xs justify-left"
                  >
                    <div
                    ...
                    >
                      <div
                        v-for="(item, _index) in detailreport(
                          groupreport.sort_number,
                          idx + 1
                        )"
                        :key="_index"
                        class="row items-start justify-left q-mb-sm"
                      >
                        <div v-if="item.is_header === 1">
                          <span class="text-uppercase q-my-md text-grey-10"
