  ...
  <q-page class="page-app">
          ...
          >
            ...
            >
              <div class="grid-data">
                ...
                <div
                  v-else-if="
                    col.name === 'origins' || col.name === 'destinations'
                  "
                >
                  <span
                    :class="
                      props.row.is_active === '0'
                        ? 'bg-red-10 text-white q-pa-xs'
                        : 'q-pa-xs'
                    "
                    >{{ col.value }}</span
                  >
    ...
    >
        ...
        <div class="row items-start q-col-gutter-sm q-mb-sm">
          <div class="col-xs-6 col-sm-3 col-md-2">
            <q-field
              ...
              stack-label
              dense
              :model-value="edit.standart_cost"
              label="Biaya Operasional"
            >
              <template v-slot:control>
                <vue-numeric
                  v-model="edit.standart_cost"
            ...
            >
              <template v-slot:control>
                <vue-numeric
                  ...
                  :precision="0"
                  @input="
                    edit.fleet_price = edit.standart_price + edit.other_fee
                  "
                />
              </template>
            </q-field>
          ...
          <div class="col-xs-6 col-sm-3 col-md-2">
            <q-field
              ...
              stack-label
              dense
              :model-value="edit.other_fee"
              label="Tambahan Lain2"
            >
              <template v-slot:control>
                <vue-numeric
                  v-model="edit.other_fee"
                  class="q-field__input text-right"
                  separator="."
                  :precision="0"
                  @input="
          ...
          <div class="col-xs-6 col-sm-3 col-md-2">
            <q-field
              ...
              stack-label
              dense
              :model-value="edit.fleet_price"
              label="Net Tarif"
            >
              <template v-slot:control>
                <vue-numeric
                  v-model="edit.fleet_price"
                  class="q-field__input text-right"
                  separator="."
                  :precision="0"
                  disable
      ...
      <q-table
        ...
        separator="cell"
        selection="single"
        v-model:selected="sel_cost"
        v-model:pagination="pg_cost"
        dense
        hide-bottom
        hide-pagination
      >
              ...
              <div class="grid-data">
                <div v-if="col.name === 'fleet_cost'">
                  <q-field
                    ...
                    outlined
                    dense
                    :model-value="props.row.fleet_cost"
                    style="max-width: 200px"
                  >
                    <template v-slot:control>
                      <vue-numeric
                        v-model="props.row.fleet_cost"
                        class="q-field__input text-right"
                        separator="."
                        :precision="0"
    ...
    >
      <q-toolbar class="main-toolbar">
        ...
        <q-checkbox
          ...
          false-value="0"
          dense
          label="Hanya tarif yang berlaku"
  ...
  setup() {
    ...
    const col_cost = ref([
      { name: 'line_no', align: 'left', label: 'No', field: 'line_no' },
      {
        name: 'descriptions',
        align: 'left',
        label: 'Variable biaya operasional',
        field: 'descriptions'
      },
      {
        name: 'fleet_cost',
