  ...
  <q-page class="page-app">
    ...
    <q-card class="icard" square>
      <q-bar class="entry-caption">
        Penerimaan Kas/Bank - {{(stateform==='new') ?' Dokumen Baru' : edit.trans_code+'-'+edit.trans_series}}
      </q-bar>
      <q-card-section class="q-gutter-sm">
        <div class="row items-start q-col-gutter-sm q-mb-sm">
          <div class="col-xs-6 col-sm-6 col-md-2">
            <q-input v-model="edit.transid" dense outlined square label="No.Dokumen" stack-label readonly />
          </div>
          <div class="col-xs-6 col-sm-6 col-md-2">
          ...
          <div class="col-xs-6 col-sm-6 offset-md-4 col-md-2">
            <q-input v-model="edit.reference1" dense outlined square label="Referensi 1" stack-label />
          </div>
          <div class="col-xs-6 col-sm-6  col-md-2">
            <q-input v-model="edit.reference2" dense outlined square label="Referensi 2" stack-label />
          </div>
        </div>
        <div class="row items-start q-col-gutter-sm q-mb-sm">
        ...
        <div class="row items-start q-col-gutter-sm q-mb-sm">
          <div class="col-xs-6 col-sm-3  col-md-2">
            <q-input v-model="edit.due_date" dense outlined square label="Jatuh tempo" stack-label type="date"/>
          </div>
          <div class="col-xs-6 col-sm-3 col-md-2">
            <q-input v-model="edit.cheque_no" dense outlined square label="No. Cek/Giro" stack-label/>
          </div>
        ...
        <div class="row items-start q-col-gutter-sm q-mb-sm">
          <div class="col-xs-6 col-sm-6  col-md-4">
            <q-checkbox v-model="edit.is_ge" true-value="1" false-value="0" label="Transaksi ini merupakan General Ledger"/>
          </div>
          <div class="col-xs-6 col-sm-3 offset-md-4 col-md-2">
      ...
      <q-table square :rows="details" :columns="columns" no-data-label="data kosong" dense
            ...
            <q-td v-for="col in props.cols" :key="col.name" :props="props">
              <div class="grid-data">
                ...
                <div v-else-if="col.name === 'line_memo'">
                  <input v-model="props.row.line_memo" class="input" style="width:100%"/>
                </div>
                <div v-else-if="col.name === 'amount'">
                  <vue-numeric v-model="props.row.amount" class="right-input" separator="."
                    @input="calculate_amount()" style="width:100%"/>
                </div>
                <div v-else-if="col.name === 'enum_type'">
                  <select v-model="props.row.eum_type" class="input"  style="width=100%">
                    <option>-</option>
                ...
                <div v-else-if="col.name === 'work_order_no'">
                  <input v-model="props.row.work_order_no" class="input q-mr-sm" readonly/>
                  <q-icon name="search" color="green-10"/>
                </div>
                <div v-else-if="col.name === 'partner_name'">
                  <input v-model="props.row.partner_name" class="input q-mr-sm" readonly/>
                  <q-icon name="search" color="green-10"/>
                </div>
                <div v-else>
                  {{ col.value }}
...
export default defineComponent({
  ...
  setup () {
    ...
    const columns = ref([
      ...
      { name: 'line_memo', align: 'left', label: 'Keterangan', field: 'line_memo',style:"min-width:400px" },
      { name: 'amount', align: 'right', label: 'Jumlah', field: 'amount' },
      { name: 'enum_type', align: 'right', label: 'Tipe', field: 'enum_type' },
      { name: 'work_order_no', align: 'left', label: 'BPartner', field: 'work_order_no', style: "min-width:150px" },
      { name: 'partner_name', align: 'left', label: 'BPartner', field: 'partner_name', style: "min-width:250px" },
      { name: 'no_account', align: 'left', label: 'Akun', field: 'no_account',style:"min-width:100px"}
    ]);
