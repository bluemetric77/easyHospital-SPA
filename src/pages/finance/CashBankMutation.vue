        ...
        <div class="row items-center q-col-gutter-sm q-mb-sm">
          <div class="col-xs-6 col-sm-3">
            <q-field
              ...
              stack-label
              dense
              :model-value="balance.begining"
              label="Saldo Awal"
            >
              <template v-slot:control>
                <vue-numeric
                  v-model="balance.begining"
            ...
            >
              <template v-slot:control>
                <vue-numeric
                  ...
                  separator="."
                  :precision="2"
                  style="font-weight: bold; font-size: 12px; color: blue"
                  readonly
                />
              </template>
            </q-field>
            ...
            >
              <template v-slot:control>
                <vue-numeric
                  ...
                  separator="."
                  :precision="2"
                  style="font-weight: bold; font-size: 12px; color: red"
                  readonly
                />
              </template>
            </q-field>
          ...
          <div class="col-xs-6 col-sm-3">
            <q-field
              ...
              stack-label
              dense
              :model-value="balance.last"
              label="Saldo Akhir"
            >
              <template v-slot:control>
                <vue-numeric
                  v-model="balance.last"
                  class="q-field__input text-right"
                  separator="."
                  :precision="2"
                  style="font-weight: bold; font-size: 12px"
              ...
              <div class="grid-data">
                ...
                <div v-else-if="col.name === 'linkdoc_number'">
                  <q-btn
                    ...
                    dense
                    rounded
                    class="bg-green-10 text-white q-mr-xs"
                    @click="print_gl(props.row.no_jurnal)"
                  />
                  <q-btn
                    :label="props.row.linkdoc_number"
                    no-caps
                    flat
                    class="text-green-10"
...
export default defineComponent({
  ...
  setup() {
    ...
    async function loaddata() {
      ...
      ;(props.cash_id = cash_id.value), (props.date1 = date1.value)
