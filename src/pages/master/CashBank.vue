            ...
            >
              <div class="grid-data">
                ...
                <div v-else-if="col.name === 'is_headoffice'">
                  <q-toggle
                    v-model="props.row.is_headoffice"
                    dense
                    true-value="1"
                    false-value="0"
                    disable
                ...
                <div v-else-if="col.name === 'is_operasional'">
                  <q-toggle
                    v-model="props.row.is_operasional"
                    dense
                    true-value="1"
                    false-value="0"
                    disable
                ...
                <div v-else-if="col.name === 'is_usedinvoice'">
                  <q-toggle
                    v-model="props.row.is_usedinvoice"
                    dense
                    true-value="1"
                    false-value="0"
                    disable
      ...
      >
        ...
        <q-card-section class="q-gutter-sm">
          ...
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-toggle
                v-model="edit.is_headoffice"
                label="Kas/Bank khsusu kantor pusat"
                true-value="1"
                false-value="0"
                dense
              />
          ...
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            ...
            <div class="col-6">
              <q-toggle
                v-model="edit.is_usedinvoice"
                label="Rekening untuk penagihann (Invoice)"
                true-value="1"
                false-value="0"
                dense
              />
