        ...
        >
          <q-btn-toggle
            ...
            :options="[
              ...
              {
                label: 'Biaya & Pendapatan Lain',
                value: 'BIAYA & PENDAPATAN LAIN'
              },
          ...
          >
            ...
            >
              <div class="grid-data">
                ...
                <div
                  v-else-if="
                    col.name === 'account_no' || col.name === 'account_name'
                  "
                >
                ...
                <div v-else-if="col.name === 'is_cash_bank'">
                  <q-toggle
                    v-model="props.row.is_cash_bank"
                    dense
                    true-value="1"
                    false-value="0"
                    disable
      ...
      >
        ...
        <q-card-section class="q-gutter-sm">
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-12">
              <q-select
                v-model="edit.account_header"
                :options="accountsheader"
          ...
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-toggle
                v-model="edit.is_header"
                true-value="1"
                false-value="0"
                dense
                label="Grup/header akun"
              />
            </div>
            <div class="col-6">
              <q-toggle
                v-model="edit.is_posted"
                true-value="1"
                false-value="0"
                dense
                label="Akun detail/posting"
              />
            </div>
          </div>
