              ...
              <div class="grid-data">
                ...
                <div v-else-if="col.name === 'partner_name'">
                  ...
                  <span
                    class="text-red-10"
                    v-else
                    >{{ props.row.partner_name }}</span
                  >
                </div>
                <div v-else-if="col.name === 'partner_address'">
                  <q-input
                    v-model="props.row.partner_address"
                    borderless
                    autogrow
                    type="textarea"
                ...
                <div v-else-if="col.name === 'invoice_address'">
                  <q-input
                    v-model="props.row.invoice_address"
                    borderless
                    autogrow
                    type="textarea"
                    input-style="width:300px"
            ...
            <div class="row items-start q-col-gutter-sm">
              ...
              <div class="col-6">
                <q-select
                  ...
                  :options="itemgroupsopt"
                  outlined
                  dense
                  options-dense
                  label="Pembayaran via"
                  option-value="item_group"
                  option-label="item_group_name"
                  emit-value
                  map-options
                  fill-input
                  stack-label
            ...
            <div class="row items-start q-col-gutter-sm q-mb-xs">
              <div class="col-4">
                <q-field
                  ...
                  stack-label
                  dense
                  :model-value="edit.fee_of_storage"
                  label="Tarif Inap perhari"
                >
                  <template v-slot:control>
                    <vue-numeric
                      v-model="edit.fee_of_storage"
            ...
            <div class="row items-start q-col-gutter-sm q-mb-xs">
              <div class="col-4">
                <q-field
                  ...
                  stack-label
                  dense
                  :model-value="edit.fee_of_tonase"
                  label="Tarif per Tonase"
                >
                  <template v-slot:control>
                    <vue-numeric
                      v-model="edit.fee_of_tonase"
                      class="q-field__input text-right"
                      separator="."
                      :precision="0"
                    />
              ...
              <div class="col-4">
                <q-field
                  ...
                  stack-label
                  dense
                  :model-value="edit.minimum_tonase"
                  label="Minimum Tonase"
                >
                  <template v-slot:control>
                    <vue-numeric
                      v-model="edit.minimum_tonase"
                      class="q-field__input text-right"
                      separator="."
                      :precision="0"
                    />
            ...
            <div class="row items-start q-col-gutter-sm q-mb-xs">
              <div class="col-4">
                <q-field
                  ...
                  stack-label
                  dense
                  :model-value="edit.maximum_credit"
                  label="Tarif per Tonase (/Kg)"
                >
                  <template v-slot:control>
                    <vue-numeric
                      v-model="edit.maximum_credit"
                      class="q-field__input text-right"
                      separator="."
                      :precision="0"
                    />
              ...
              <div class="col-4">
                <q-field
                  ...
                  stack-label
                  dense
                  :model-value="edit.due_interval"
                  label="Interval Jatuh Tempo (x hari)"
                >
                  <template v-slot:control>
                    <vue-numeric
                      v-model="edit.due_interval"
                      class="q-field__input text-right"
                      separator="."
                      :precision="0"
                    />
