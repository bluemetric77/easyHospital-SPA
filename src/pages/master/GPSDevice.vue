          ...
          <q-tr :props="props" @click="props.selected = !props.selected">
            <q-td v-for="col in props.cols" :key="col.name" :props="props">
              <div class="grid-data">
                ...
                <div v-else-if="col.name === 'gps_signal'">
                  <q-toggle v-model="props.row.gps_signal" dense true-value="1" false-value="0" disable />
                </div>
      ...
      <q-card class="icard" style="width: 700px" square>
        ...
        <q-card-section class="q-gutter-sm">
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-input v-model="edit.device_id" dense outlined square label="ID GPS" stack-label />
            </div>
            <div class="col-6">
              <q-input v-model="edit.vehicle_no" dense outlined square label="No.Unit/Kendaraan" stack-label />
            </div>
          </div>
      ...
      if (selected.value.length > 0 || !(primary === '')) {
        ...
        try {
          ...
          if (!(typeof respon === "undefined")) {
            dataevent.value = true;
            edit.value = respon;
            edit.value.old_sysid=respon.sysid
          }
        } finally {
          $q.loading.hide();
        }
