      ...
      <q-card class="icard" style="width: 700px" square>
        ...
        <q-card-section class="q-gutter-sm">
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-input v-model="edit.geofance_name" dense outlined square label="Nama Geofance" stack-label />
            </div>
            <div class="col-6">
              <q-input v-model="edit.warehouse" dense outlined square label="Pabrik/Gudang" stack-label />
            </div>
          </div>
          <div class="row items-start q-col-gutter-sm q-mt-xs">
            <div class="col-12">
              <q-input v-model="edit.location" dense outlined square label="Alamat" stack-label />
            </div>
          </div>
          <div class="row items-start q-col-gutter-sm q-mt-xs">
            <div class="col-12">
