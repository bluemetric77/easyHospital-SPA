            ...
            >
              <div class="grid-data">
                ...
                <div v-else-if="col.name === 'personal_address'">
                  <q-input
                    v-model="props.row.personal_address"
                    borderless
                    autogrow
                    type="textarea"
        ...
        >
          <q-tab-panel name="general">
            ...
            <div class="row items-start q-col-gutter-sm q-mb-xs">
              <div class="col-6">
                <q-input
                  v-model="edit.emergency_contact"
                  dense
                  outlined
                  square
            ...
            <div class="row items-start q-col-gutter-sm q-mb-xs">
              <div class="col-12">
                <q-input
                  v-model="edit.emergency_address"
                  dense
                  outlined
                  square
          ...
          <q-tab-panel name="configuration">
            ...
            <div class="row items-start q-col-gutter-sm q-mb-xs">
              <div class="col-4">
                <q-input
                  v-model="edit.driving_license_type"
                  dense
                  outlined
                  square
                  label="Jenis SIM"
              ...
              <div class="col-4">
                <q-input
                  v-model="edit.driving_license_no"
                  dense
                  outlined
                  square
                  label="No. SIM"
              ...
              <div class="col-4">
                <q-input
                  v-model="edit.driving_license_valid"
                  dense
                  outlined
                  square
                ...
                <div class="row items-start">
                  <div class="col-12">
                    <q-file
                      ...
                      dense
                      rounded
                      label="Upload foto indentitas (Max 2 MB)"
                      accept=".jpg,image/*"
...
export default defineComponent({
  ...
  setup() {
        ...
        try {
          ...
          if (!(typeof respon === 'undefined')) {
            ...
            edit.value.ktp =
              ...
              edit.value.personal_id +
              '&document=ktp'
            edit.value.kartu_keluarga =
              url_link +
              '?personal_id=' +
              edit.value.personal_id +
              '&document=kartu_keluarga'
            edit.value.photo =
              url_link +
              '?personal_id=' +
              edit.value.personal_id +
    ...
    function upload_file(types = '') {
      ...
      $store.dispatch('master/UPLOAD_DATA', json).then(async (respon) => {
        let msg = respon.data
        if (respon.success === true) {
          if (types === 'photo') {
            ...
            edit.value.kartu_keluarga = URL.createObjectURL(
              kartu_keluarga.value
            )
          }
          this.$q.notify({
    ...
    function onRejected(rejectedEntries) {
      this.$q.notify({
        ...
        textcolor: 'white',
        message:
          '${rejectedEntries.length} Ukuran file yang diupload lebih dari 2MB',
        position: 'top',
        timeout: 2000
      })
    }
