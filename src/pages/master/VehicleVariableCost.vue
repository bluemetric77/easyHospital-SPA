      ...
      >
        ...
        <q-card-section class="q-gutter-sm">
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-8">
              <q-input
                ...
                outlined
                square
                label="Variable biaya opersional"
                stack-label
              />
            </div>
            <div class="col-4">
              <q-input
                v-model="edit.sortname"
                dense
                outlined
                square
                label="Variable (Singkatan)"
                stack-label
              />
            </div>
          </div>
          ...
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-toggle
                v-model="edit.is_invoice"
                label="Variable biaya ditagihkan"
                true-value="1"
                false-value="0"
                dense
              />
          ...
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-toggle
                v-model="edit.is_auto"
                label="Otomatis ditagihkan"
                true-value="1"
                false-value="0"
                dense
              />
