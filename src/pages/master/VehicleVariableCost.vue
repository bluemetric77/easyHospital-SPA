            ...
            <q-td v-for="col in props.cols" :key="col.name" :props="props">
              <div class="grid-data">
                ...
                <div v-else-if="col.name === 'is_invoice'">
                  <q-toggle v-model="props.row.is_invoice" dense true-value="1" false-value="0" disable />
                </div>
                <div v-else-if="col.name === 'is_fix'">
                  <q-toggle v-model="props.row.is_fix" dense true-value="1" false-value="0" disable />
                </div>
                <div v-else-if="col.name === 'is_auto'">
                  <q-toggle v-model="props.row.is_auto" dense true-value="1" false-value="0" disable />
                </div>
      ...
      <q-card class="icard" style="width: 700px" square>
        ...
        <q-card-section class="q-gutter-sm">
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-8">
              <q-input v-model="edit.descriptions" dense outlined square label="Variable biaya opersional"
                stack-label />
            </div>
            <div class="col-4">
              <q-input v-model="edit.sortname" dense outlined square label="Variable (Singkatan)" stack-label />
            </div>
          </div>
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-input v-model="edit.account_no" dense outlined square label="Akun Biaya" stack-label>
                <template v-slot:append>
            ...
            <div class="col-6">
              <q-select v-model="edit.acuan" :options="['COST','FEE']" options-dense outlined square
                label="Acuan Invoice" stack-label dense />
            </div>
          </div>
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-toggle v-model="edit.is_invoice" label="Variable biaya ditagihkan" true-value="1" false-value="0"
                dense />
            </div>
            <div class="col-6">
              <q-toggle v-model="edit.is_fix" label="Variable biaya tetap" true-value="1" false-value="0" dense />
            </div>
          </div>
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-toggle v-model="edit.is_auto" label="Otomatis ditagihkan" true-value="1" false-value="0" dense />
            </div>
            <div class="col-6">
              <q-toggle v-model="edit.is_active" label="Variable aktif" true-value="1" false-value="0" dense />
            </div>
          </div>
        </q-card-section>
        <q-separator />
