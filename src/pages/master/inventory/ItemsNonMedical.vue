<template>
  <q-page class="page-app">
    ...
    <!-- Dialog UI Interface-->
    <q-dialog v-model="dataevent" persistent transition-show="flip-down" transition-hide="flip-up" full-width>
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="row items-start q-col-gutter-sm q-mb-sm">
                  <div class="col-xs-6 col-sm-3">
                     <q-input v-model="edit.item_code" label="Kode Item" dense square outlined stack-label/>
                  </div>
                  <div class="col-xs-6 col-sm-3">
                    <q-input v-model="edit.item_code_old" label="Kode Item Lama" dense square outlined stack-label disable/>
                  </div>
                </div>
                <div class="row items-start q-col-gutter-sm q-mb-sm">
                  <div class="col-xs-12 col-sm-6">
                    <q-input v-model="edit.item_name1" label="Nama Item" dense square outlined stack-label />
                  </div>
                  <div class="col-xs-12 col-sm-6">
                    <q-input v-model="edit.item_name2" label="Nama Item (alternatif)" dense square outlined stack-label/>
                  </div>
                </div>
                <div class="row items-start q-mb-sm">
                  <div class="col-12">
                    <q-card square>
                      <q-bar class="entry-caption" dense>Parameter Item Inventory</q-bar>
                      <q-card-section class="q-pa-sm">
                          <div class="row items-start q-mb-sm">
                            <div class="col-xs-12 col-sm-6">
                              <q-select v-model="edit.mou_inventory" label="Satuan simpan" dense square outlined stack-label
                          ...
                          <div class="row items-start q-mb-sm">
                            <div class="col-12">
                              <q-input v-model="edit.manufactur" label="Manufaktur/Pabrik" dense square outlined stack-label readonly>
                                <template v-slot:append>
                                  <q-icon
                                   name="search"
                                   size="sm"
                          ...
                          <div class="row items-center q-col-gutter-sm q-mb-sm">
                            ...
                            <div class="col-4">
                              <q-checkbox v-model="edit.is_purchase" label="Beli" dense />
                            </div>
                            <div class="col-4">
    ...
    <itemgroup v-if="dlgItemGroup" :show="dlgItemGroup" groupname='GENERAL' @CloseData="getItemGroup" />
  </q-page>
</template>
