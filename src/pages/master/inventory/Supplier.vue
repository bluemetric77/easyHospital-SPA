  ...
  <q-page class="page-app">
    ...
    <q-dialog v-model="dataevent" persistent transition-show="flip-down" transition-hide="flip-up">
      <q-card class="icard" square style="width:500px;max-width:90vw">
        ...
        <q-card-section style="height:79vh" class="q-pa-sm scroll">
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-input v-model="edit.supplier_code" dense outlined square label="Kode" stack-label />
            </div>
            <div class="col-6">
              <q-checkbox v-model="edit.is_active" dense outlined square label="Status (Aktif)" stack-label />
            </div>
          </div>
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            <div class="col-12">
              <q-input v-model="edit.supplier_name" dense outlined square label="Nama Supplier" stack-label />
            </div>
          </div>
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            <div class="col-12">
              <q-input v-model="edit.address" dense outlined square label="Alamat" stack-label type="textarea" input-style="max-height:50px"/>
            </div>
          </div>
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            <div class="col-4">
            ...
            <div class="col-4">
              <q-input v-model="edit.phone2" dense outlined square label="Telepoon 2" stack-label />
            </div>
            <div class="col-4">
              <q-input v-model="edit.fax" dense outlined square label="Fax" stack-label />
            </div>
          </div>
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            <div class="col-12">
          ...
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-12">
              <q-input v-model="edit.contact_person" dense outlined square label="Nama Kontak" stack-label />
            </div>
          </div>
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-input v-model="edit.contact_phone" dense outlined square label="Telepon" stack-label />
            </div>
            <div class="col-6">
              <q-input v-model="edit.contact_email" dense outlined square label="Email" stack-label />
            </div>
          </div>
          <q-bar class="entry-caption q-my-sm">Bank Pembayaran</q-bar>
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-12">
              <q-input v-model="edit.bank_name" dense outlined square label="Nama Bank" stack-label />
            </div>
          </div>
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-input v-model="edit.bank_account_name" dense outlined square label="Nama Akun/Rekening" stack-label />
            </div>
            <div class="col-6">
              <q-input v-model="edit.bank_account_number" dense outlined square label="Nomor Rekening" stack-label />
            </div>
          </div>
        </q-card-section>
        <q-separator />
