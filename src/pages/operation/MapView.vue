<template>
  <q-page class="page-app">
    ...
    >
      <q-toolbar class="main-toolbar">
        ...
        <q-btn
          ...
          no-caps
          rounded
          :to="{ name: 'monitoring-unit', force: true }"
        />
      </q-toolbar>
    </q-page-sticky>
    ...
    <q-card
      ...
      square
    >
      <q-bar class="entry-caption"> Monitoring Unit </q-bar>
                ...
                >
                  ...
                  >
                    ...
                    <template v-slot:no-data="{ icon, message, filter }">
                      <div
                        class="full-wtransidth row flex-top text-accent q-gutter-sm"
                      >
                        <q-icon
                          size="2em"
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      const map = new mapboxgl.Map({
        ...
        center: [106.816666, -6.2], // starting position [lng, lat]
        zoom: 12
      })
        ...
        async function getLocation(updateSource) {
          ...
          try {
            const response = await fetch(
              'https://app.dutamediamandiri.com/v1/api/operation/gps_update?vehicle_no=' +
                vehicle_no.value,
              { method: 'GET' }
            )
