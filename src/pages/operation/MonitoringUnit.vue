    ...
    >
      ...
      <q-card-section class="q-pa-sm">
        <div class="row items-center q-col-gutter-sm">
          ...
          <div
            class="col-xs-12 col-sm-12 offset-md-2 col-md-2"
            v-show="all === '1'"
          >
            <q-btn-toggle
              v-model="all"
          ...
          <div
            class="col-xs-12 offset-sm-2 col-sm-4 offset-md-6 col-md-2"
            v-show="all === '0'"
          >
            <q-btn-toggle
              v-model="all"
                ...
                <q-card class="dashboard-card">
                  <q-card-section horizontal>
                    ...
                    <q-card-section class="q-pt-md col-11 text-center">
                      ...
                      <div class="text-body3 q-mt-sm q-mb-xs">Total Unit</div>
                    </q-card-section>
                  </q-card-section>
                </q-card>
              </div>
                ...
                >
                  <q-card-section horizontal>
                    ...
                    <q-card-section class="q-pt-md col-11 text-center">
                      ...
                      <div class="text-body3 q-mt-sm q-mb-xs">GPS Update</div>
                    </q-card-section>
                  </q-card-section>
                </q-card>
              </div>
                ...
                >
                  <q-card-section horizontal>
                    ...
                    <q-card-section class="q-pt-md col-11 text-center">
                      ...
                      <div class="text-body3 q-mt-sm q-mb-xs">Tidak Update</div>
                    </q-card-section>
                  </q-card-section>
                </q-card>
              </div>
            ...
            <div class="row justify-between q-col-gutter-sm">
              ...
              <div class="col-xs-4 col-sm-2">
                <q-card class="dashboard-card">
                  ...
                  <q-card-section class="text-center q-pt-md col-11">
                    <div
                      class="text-weight-bold text-green-10 text-center"
                      style="font-size: 2.25em"
                    >
                ...
                >
                  <div class="grid-data">
                    ...
                    <div v-else-if="col.name === 'state_gps'">
                      <span
                        :class="
                          props.row.state_gps === 'Parking'
                            ? 'q-pa-xs bg-red-10 text-white'
                            : props.row.state_gps === 'Driving'
                            ? 'q-pa-xs bg-green-10 text-white'
                            : props.row.state_gps === 'Idle'
                            ? 'q-pa-xs bg-yellow-10 text-white'
                            : 'q-pa-xs'
                        "
                        >{{ props.row.state_gps }}</span
                      >
                    </div>
                    ...
                    <div v-else-if="col.name === 'work_order_number'">
                      <div v-if="!(props.row.work_order_number === '')">
                        <q-btn
                          :label="props.row.work_order_number"
                          dense
                          glossy
                          rounded
      ...
      <q-tab-panel name="detail">
        ...
        >
          ...
          <q-table
            ...
            separator="cell"
            selection="single"
            v-model:selected="selected_spj"
            v-model:pagination="pagination_spj"
            binary-state-sort
            @request="onRequestSPJ"
            :loading="loading_spj"
            virtual-scroll
          >
            <template v-slot:loading>
                ...
                >
                  <div class="grid-data">
                    ...
                    <div v-else-if="col.name === 'origins_geofance_in'">
                      {{ $INDDateTime(props.row.origins_geofance_in) }} s/d
                      {{ $INDDateTime(props.row.origins_geofance_out) }}
                    </div>
    ...
    >
      ...
      >
        ...
        <q-table
          ...
          separator="cell"
          selection="single"
          v-model:selected="selected_state"
          v-model:pagination="pagination_state"
          binary-state-sort
          @request="onRequestState"
      ...
      >
        ...
        <q-card-section class="q-pa-xs">
          ...
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-6">
              <q-input
                v-model="vehicle.work_order_number"
                label="Surat Muatan"
                dense
                outlined
                square
            ...
            <div class="col-6">
              <q-input
                v-model="vehicle.work_order_date"
                label="Tgl.Kegiatan"
                dense
                type="date"
                outlined
          ...
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-12">
              <q-input
                v-model="vehicle.work_order_driver_name"
                label="Pengemudi"
                dense
                outlined
                square
    ...
    >
      ...
      >
        ...
        <q-card-section class="q-pa-xs">
          ...
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-12 text-bold">Waktu Muat Barang</div>
          </div>
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-12">
              <q-input
          ...
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-4">
              <q-input
                v-model="edit.origins_geofance_in"
                label="Tgl Mulai"
                type="date"
                dense
                outlined
            ...
            <div class="col-2">
              <q-input
                v-model="edit.origins_geofance_in_time"
                label="Jam Mulai"
                type="time"
                dense
                outlined
            ...
            <div class="col-4">
              <q-input
                v-model="edit.origins_geofance_out"
                label="Tgl Selesai"
                type="date"
                dense
                outlined
            ...
            <div class="col-2">
              <q-input
                v-model="edit.origins_geofance_out_time"
                label="Jam Selesai"
                type="time"
                dense
                outlined
          ...
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-12 text-bold">Waktu Bongkar Barang</div>
          </div>
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-12">
              <q-input
          ...
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-4">
              <q-input
                v-model="edit.destinations_geofance_in"
                label="Tgl Mulai"
                type="date"
                dense
                outlined
            ...
            <div class="col-2">
              <q-input
                v-model="edit.destinations_geofance_in_time"
                label="Jam Mulai"
                type="time"
                dense
                outlined
            ...
            <div class="col-4">
              <q-input
                v-model="edit.destinations_geofance_out"
                label="Tgl Selesai"
                type="date"
                dense
                outlined
            ...
            <div class="col-2">
              <q-input
                v-model="edit.destinations_geofance_out_time"
                label="Jam Selesai"
                type="time"
                dense
                outlined
          ...
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-12">
              <q-checkbox
                v-model="edit.is_closed_order"
                label="Kegiatan operasi selesai"
                dense
                true-value="1"
                false-value="0"
              />
...
export default defineComponent({
  ...
  setup() {
    ...
    const columns_state = ref([
      ...
      {
        name: 'state_gps_datetime',
        align: 'left',
        label: 'Mulai',
        field: 'state_gps_datetime'
      },
      {
        name: 'geofance_name',
        align: 'left',
    ...
    const columns_spj = ref([
      ...
      {
        name: 'origins_geofance',
        align: 'left',
        label: 'Geofance Muat',
        field: 'origins_geofance'
      },
      {
        name: 'origins_geofance_in',
        align: 'center',
        label: 'Keluar/Masuk Muat',
        field: 'origins_geofance_in'
      },
      {
        name: 'destinations_geofance',
        align: 'left',
        label: 'Geofance Bongkaran',
        field: 'destinations_geofance'
      },
      {
        name: 'destinations_geofance_in',
        align: 'center',
        label: 'Keluar Masuk Bongkaran',
        field: 'destinations_geofance_in'
      }
    ])
