  ...
  <q-page class="page-app">
    ...
    >
      ...
      <q-toolbar class="main-toolbar">
        <q-btn
          label="Pengajuan biaya operasional"
          icon="add"
          dense
          flat
          @click="add_lbo(-1)"
              ...
              <div class="grid-data">
                <div v-if="col.name === 'doc_number'">
                  ...
                  <q-btn
                    ...
                    dense
                    no-caps
                    class="q-ml-sm bg-red-10 text-white"
                ...
                <div v-else-if="col.name === 'voucher'">
                  ...
                  <div v-else>
                    <q-btn
                      ...
                      dense
                      no-caps
                      class="bg-red-10 text-white q-mr-sm"
                ...
                <div v-else-if="col.name === 'authorize_userid'">
                  ...
                  <div v-else>
                    <q-btn
                      ...
                      no-caps
                      label="Otorisasi"
                      @click="authorize_lbo(props.row.transid)"
    ...
    >
      <q-card
        class="icard"
        square
        style="min-width: 500px; max-width: 80vw; max-height: 600px"
      >
        <q-bar class="entry-caption">
        ...
        <q-card-section class="q-pa-sm">
          ...
          <div
            v-show="cost.is_primary === '1'"
            class="row items-start q-col-gutter-xs q-mb-xs"
          >
            <div class="col-xs-6 col-sm-4 col-md-3">
              <q-field
                square
          ...
          <div class="row items-start q-col-gutter-xs q-mb-xs">
            <div class="col-xs-6 col-sm-4 col-md-3">
              <q-field
                ...
                stack-label
                dense
                :model-value="cost.standart"
                label="Standar UJO"
              >
                <template v-slot:control>
                  <vue-numeric
                    v-model="cost.standart"
                    class="q-field__input text-right"
                    separator="."
                    readonly
                  />
                    ...
                    >
                      <template v-slot:control>
                        <vue-numeric
                          ...
                          separator="."
                          :disabled="
                            cost.is_primary === '1' || is_authorize === '1'
                          "
    ...
    >
      ...
      >
        ...
        <q-table
          ...
          separator="cell"
          selection="single"
          v-model:selected="selected_cashier"
          v-model:pagination="pagination_cashier"
          binary-state-sort
          virtual-scroll
          class="fit my-sticky-dynamic"
          table-style="min-height:302px; max-height: 370px"
