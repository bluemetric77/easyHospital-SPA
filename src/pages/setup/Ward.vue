      ...
      >
        ...
        <q-card-section class="q-gutter-sm">
          <div class="row items-center q-col-gutter-sm q-mb-sm">
            ...
            <div class="col-6">
              <q-input
                v-model="edit.ward_name"
                dense
                outlined
                square
                label="Nama Ruang Perawatan"
                stack-label
              />
            </div>
            <div class="col-3">
          ...
          <div class="row items-start q-col-gutter-sm q-mb-sm">
            <div class="col-12">
              <q-input
                v-model="edit.inpatient_service"
                dense
                outlined
                square
                label="Jenis Pelayanan Rawat Inap"
                stack-label
                readonly
              >
                <template v-slot:append>
